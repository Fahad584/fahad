...
namespace Rock_Paper_Scissors
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-HVVMAVQ;Initial Catalog=rock;Integrated Security=True");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                a="CPU Wins This Game";
                }
                con.Open();
                SqlCommand cmd = new SqlCommand("insert into RPS values('" + AIwins + "','" + playerwins + "','" + a + "')", con);
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            // TODO: This line of code loads data into the 'rockDataSet.RPS' table. You can move, or remove it, as needed.
            this.rPSTableAdapter.Fill(this.rockDataSet.RPS);
